...
public:
	...
	// Se ejecuta cuando el efecto llega a 0 segundos y se elimina (revertir velocidad, apagar fuego...)
	virtual void OnStatusHitted(class UStatusComponent* TargetComp, struct FActiveStatusEffect& EffectData) const {}
...
protected:
	...
	void ShowDamageNumbers(const FVector& SpawnLocation, const float& TotalDamage, const FLinearColor& Color, UWorld* World) const;
};